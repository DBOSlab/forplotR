...
test_that("forplot_vouchers errors on missing fp_file_path", {
  expect_error(
    forplot_vouchers(fp_file_path = tempfile(fileext = ".xlsx")),
...
test_that("forplot_vouchers creates correct Family/Genus/Voucher dirs for collected vouchers", {
  skip_if_not_installed("openxlsx")
...
test_that("forplot_vouchers moves photos from outdated genus folder and deletes empty old folder", {
  skip_if_not_installed("openxlsx")
  skip_if_not_installed("readxl")
...
test_that("forplot_vouchers preserves existing destination files and moves non-duplicate files", {
  skip_if_not_installed("openxlsx")
  skip_if_not_installed("readxl")
