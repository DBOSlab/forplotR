...
Below are the description of the four main functions (`forplot_sheets`, `forplot_vouchers`, `forplot_balance` and `forplot_map`) available in the package and how to use them.\
