...
.create_rmd_content <- function(subplot_plots, tf_col, tf_uncol, tf_palm, plot_name, plot_code) {
  ...
  mid_section <- c(
    ...
    "cat('\\n\\\\begin{center}')",
    "cat(sprintf('\\\\href{https://dboslab.github.io/forplotR-website/}{\\\\includegraphics[width=0.2\\\\linewidth]{%s}}\n', forplotr_logo_path))",
    "cat('\\n\\\\end{center}')",
    "cat('\\n\\\\begin{center}')",
    "cat(sprintf('\\\\href{https://forestplots.net}{\\\\includegraphics[width=0.4\\\\linewidth]{%s}}\n', forestplots_logo_path))",
    "cat('\\n\\\\end{center}')",
